...
- Привычки, созданные через форму, синхронизируются всем участникам; импорт остается личным.
...
Если Supabase отвечает `email rate limit exceeded`, подождите до сброса лимита или настройте Authentication → SMTP Settings и Authentication → Rate Limits. Встроенный почтовый сервис Supabase ограничивает частые письма подтверждения, особенно во время тестов регистрации.
