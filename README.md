...
- Новая привычка из формы автоматически появляется у всех участников как активная.
- Импорт данных остается личным и не синхронизирует привычки другим пользователям.
